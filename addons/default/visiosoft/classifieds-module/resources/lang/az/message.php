...
return [
    ...
    'pending_classified_status' => 'Elanınız moderator tərəfindən təsdiqlənməsi gözlənilir.',
    ...
    'classified_doesnt_exist' => "Bu reklam mövcud deyil!",
    'select_location_error' => "Xahiş edirəm xəritədə bir yer seçin!",
    'this_classified_is_not_valid_anymore' => "Bu reklam artıq etibarlı deyil!",
