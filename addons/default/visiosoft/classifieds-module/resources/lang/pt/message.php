...
return [
    ...
    'pending_classified_status' => 'O seu anúncio está com aprovação pendente do Editor.',
    ...
    'classified_doesnt_exist' => "Este anúncio não existe!",
    'select_location_error' => "Selecione um local no mapa!",
    'this_classified_is_not_valid_anymore' => "Este anúncio não é mais válido!",
