...
return [
    ...
    'classified_id' => 'آیدی اعلان ',
    'contact_with' => 'ارتباط با',
    'create_classified' => 'ایجاد اعلان ',
    'edit_classified' => 'تصحیح آگهی',
    'mandatory_fields' => 'باید خانه پوری کنید',
    'classified_post' => 'نشر اعلان',
    ...
    'post_free_classified' => 'نشر رایگان آگهی',
    ...
    'featured_classifieds' => "اعلانات برجسته",
    'trending_classifieds' => 'اعلانات مدروز',
    'search_ad_result_prefix' => 'بر',
    'search_ad_result_text' => '<strong>: شمارش</strong> تبلیغ در <strong>: نام</strong> پیدا شد',
    ...
    'no_classifieds' => 'هیچ اعلانی یافت نشد.',
    'show_display_mode' => [
        'map' => 'نقشه',
        'list' => 'لیست',
    ],
    ...
    'classified_info' => 'معلومات درمورد اعلان',
    ...
    'view' => 'چشم انداز',
    'classifieds_with_map' => 'تبلیغات با نقشه',
    'classifiedanced_sorting' => 'مرتب سازی پیشرفته',
