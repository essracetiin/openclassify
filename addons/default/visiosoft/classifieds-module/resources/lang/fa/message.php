...
return [
    ...
    'pending_classified_status' => 'اعلان شما در انتظار تأییداست.',
    ...
    'classified_doesnt_exist' => "این آگهی وجود ندارد!",
    'select_location_error' => "لطفاً مکانی را روی نقشه انتخاب کنید!",
    'this_classified_is_not_valid_anymore' => "این آگهی دیگر معتبر نیست!",
