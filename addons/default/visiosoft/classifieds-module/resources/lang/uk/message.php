...
return [
    ...
    'pending_classified_status' => 'Ваше оголошення очікує затвердження Редактором.',
    ...
    'classified_doesnt_exist' => "Цього оголошення не існує!",
    'select_location_error' => "Виберіть місце на карті!",
    'this_classified_is_not_valid_anymore' => "Це оголошення вже не діє!",
