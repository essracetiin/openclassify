...
return [
    ...
    'classified_actions' => 'اشتہار کے اعمال',
    'edit' => 'ترمیم',
    'approve' => 'منظور کریں',
    'passive' => "غیر فعال",
	'sold' => 'بیچ دیا',
    'offered_by' => 'پیش کردہ',
    'more_classifieds_by' => 'مزید اشتہارات کے ذریعہ',
    'click_phone' => 'فون نمبر دکھائیں',
    'share' => 'بانٹیں',
    'report' => 'اس اشتہار کی اطلاع دیں',
    'features' => 'خصوصیات',
    "streetview" => "گلی کا منظر",
    'recommended_classifieds' => 'آپ کے لئے تجویز کردہ اشتہارات',
    'new' => 'نئی',
    ...
    'post_free_classified' => 'مفت اشتہار پوسٹ کریں',
    ...
    'featured_classifieds' => "نمایاں اشتہارات",
    'trending_classifieds' => 'رجحانات کے اشتہارات',
    'search_ad_result_prefix' => 'پر',
    'search_ad_result_text' => '<strong>: گنتی</strong> اشتہارات آپ کے <strong>: نام</strong> تلاش میں پائے گئے',
    ...
    'no_classifieds' => 'کوئی اشتہار نہیں ملا۔',
    'show_display_mode' => [
        'map' => 'نقشہ',
        'list' => 'فہرست',
    ],
    ...
    'classified_info' => 'اشتھاراتی معلومات',
    ...
    'view' => 'دیکھیں',
    'classifieds_with_map' => 'نقشہ والے اشتہارات',
    'classifiedanced_sorting' => 'اعلی درجے کی ترتیب',
