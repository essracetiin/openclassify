...
return [
    ...
    'pending_classified_status' => 'ایڈیٹر کے ذریعہ آپ کے اشتہار کی منظوری زیر التوا ہے۔',
    ...
    'classified_doesnt_exist' => "یہ اشتہار موجود نہیں ہے!",
    'select_location_error' => "براہ کرم نقشے پر ایک مقام منتخب کریں!",
    'this_classified_is_not_valid_anymore' => "اب یہ اشتہار درست نہیں ہے!",
