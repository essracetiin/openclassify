...
return [
    ...
    'pending_classified_status' => 'Вашата реклама очаква одобрение от редактора.',
    ...
    'classified_doesnt_exist' => "Тази реклама не съществува!",
    'select_location_error' => "Моля, изберете местоположение на картата!",
    'this_classified_is_not_valid_anymore' => "Тази реклама вече не е валидна!",
