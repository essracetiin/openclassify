...
return [
    ...
    'pending_classified_status' => 'Din annons väntar på godkännande av redaktören.',
    ...
    'classified_doesnt_exist' => "Den här annonsen finns inte!",
    'select_location_error' => "Välj en plats på kartan!",
    'this_classified_is_not_valid_anymore' => "Denna annons är inte giltig längre!",
