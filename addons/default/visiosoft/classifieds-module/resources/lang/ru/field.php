...
return [
    ...
    'classified_actions' => 'Рекламные действия',
    'edit' => 'редактировать',
    'approve' => 'Утвердить',
    'passive' => "пассивный",
	'sold' => 'Продано',
    'offered_by' => 'Предложено',
    'more_classifieds_by' => 'Больше объявлений от',
    ...
    'recommended_classifieds' => 'Рекомендуемые объявления для вас',
    'new' => 'новый',
   ...
   продавец свяжется с вами как можно скорее.',
    'classified_id' => 'Идентификатор объявления',
    'contact_with' => 'Связаться с',
    'create_classified' => 'Создать объявление',
    'edit_classified' => 'Изменить объявление',
    'mandatory_fields' => 'Обязательные поля',
    'classified_post' => 'Объявление',
    ...
    'post_free_classified' => 'Разместить бесплатное объявление',
    ...
    'featured_classifieds' => "Избранные объявления",
    'trending_classifieds' => 'Trendind Classifieds',
    'search_ad_result_prefix' => 'на',
    'search_ad_result_text' => '<strong>: count</strong> объявлений было найдено в вашем поиске <strong>: name</strong>',
    ...
    'classified_info' => 'Информация об объявлении',
    ...
    'view' => 'Вид',
    'classifieds_with_map' => 'Объявления с картой',
    'classifiedanced_sorting' => 'Расширенная сортировка',
