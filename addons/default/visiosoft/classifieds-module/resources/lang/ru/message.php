...
return [
    ...
    'pending_classified_status' => 'Ваше объявление ожидает одобрения редактором.',
    ...
    'classified_doesnt_exist' => "Такого объявления не существует!",
    'select_location_error' => "Пожалуйста, выберите место на карте!",
    'this_classified_is_not_valid_anymore' => "Это объявление больше не действует!",
