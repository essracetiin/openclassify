...
return [
    ...
    'success_delete' => 'Classifiedertensie uitgevee',
    'pending_classified_status' => 'U classifiedertensie hang af van die goedkeuring deur die redakteur.',
    'extended' => ': nommer classifiedertensie (s) is suksesvol uitgebrei.',
    ...
    'no_add_found' => 'Geen classifiedertensie gevind nie!',
    'replicated_success' => 'Die classifiedertensie is suksesvol herhaal!',
    'classified_doesnt_exist' => "Hierdie classifiedertensie bestaan nie!",
    'select_location_error' => "Kies 'n plek op die kaart!",
    'this_classified_is_not_valid_anymore' => "Hierdie classifiedertensie is nie meer geldig nie!",
    'approve_status_change' => "Jou classifiedertensie se status is op aktief gestel!",
    'passive_status_change' => "Jou classifiedertensie se status is passief gestel!",
	'sold_status_change' => "Jou classifiedertensie se status is verkoop!",
	'status_change' => "Jou classifiedertensie se status is ingestel op: status!",
