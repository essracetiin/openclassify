...
return [
    ...
    'favs_classified' => [
        'name' => 'Gunstige classifiedertensies'
    ],
    'my_classified' => [
        'name' => 'Classified'
    ],
    ...
    'parent_classified' => [
        'name' => 'Verwante classifiedertensie'
    ],
    'value' => [
        'name' => 'Waarde'
    ],
    'list' => 'Lys',
    'home' => 'Tuis',
    'list-page' => 'Lys blclassifiedsy',
    'search' => 'Soek',
	'reset' => 'Reset',
    'recommended' => 'Aanbevole classifiedertensies vir u',
    'filter' => 'Filtreer',
    'sort' => 'Sorteer',
    ...
    'classified_actions' => 'Classifiedertensie-aksies',
    'edit' => 'Wysig',
    'approve' => 'Goedkeur',
    'passive' => "Passief",
	'sold' => 'Verkoop',
    'offered_by' => 'Aangebied deur',
    'more_classifieds_by' => 'Meer classifiedertensies deur',
    'click_phone' => 'Wys telefoonnommer',
    'share' => 'Deel',
    'report' => 'Rapporteer hierdie classifiedertensie',
    'features' => 'Kenmerke',
    "streetview" => "Straataansig",
    'recommended_classifieds' => 'Aanbevole classifiedertensies vir u',
    'new' => 'Nuut',
    ...
    'classified_id' => 'Classifiedertensie-ID',
    'contact_with' => 'Kontak met',
    'create_classified' => 'Skep classifiedertensie',
    'edit_classified' => 'Wysig classifiedertensie',
    'mandatory_fields' => 'Verpligte velde',
    'classified_post' => 'Classifiedertensiepos',
    ...
    'post_free_classified' => 'Plaas gratis classifiedertensie',
    'select_a_category' => 'Kies \'n kategorie',
    'select_a_sub_category' => 'Kies \'n subkategorie',
    'all_dopings_added' => 'Alle dopingtipes word by hierdie classifiedertensie gevoeg.',
    'is_get_classified' => [
        'name' => 'KRY'
    ],
    'corporate_info' => 'Korporatiewe inligting',
    'featured_classifieds' => "Gewilde classifiedertensies",
    'trending_classifieds' => 'Trendind-classifiedertensies',
    'search_ad_result_prefix' => 'aan',
    'search_ad_result_text' => '<strong>: tel</strong> classifiedertensies in u <strong>: naam</strong> soektog',
    'search_classifieds_result_message' => [
        'name' => ': tel classifiedertensies gevind vir: naam soek',
    ],
    'total' => 'Totaal',
    'quantity' => 'Hoeveelheid',
    'view_cart' => 'Bekyk mandjie',
    'no_classifieds' => 'Geen classifiedertensies gevind nie.',
    'show_display_mode' => [
        'map' => 'Kaart',
        'list' => 'Lys',
    ],
    'classifieds_list_table_thead' => [
        'name' => 'Classifiedertensie Naam',
        'price' => 'Prys',
        'publish_at' => 'Classifiedertensiedatum',
        'location_city' => 'Stad',
    ...
    'new_ad' => [
        'name' => 'Nuwe classifiedertensie',
    ],
    'profile' => [
        'name' => 'Profiel',
    ],
    'my_classifieds' => [
        'name' => 'My classifiedertensies',
    ],
    'sold_out' => [
        'name' => 'Uitverkoop',
    ],
    ...
    'classifieds_with_photo' => [
        'name' => 'Classifiedertensies Met Foto'
    ],
    'classifieds_with_video' => [
        'name' => 'Classifiedertensies Met Video'
    ],
    'yes' => [
        'name' => 'Ja'
    ],
    ...
    'user_access' => [
        ...
        'instructions' => 'Kan \'n gebruiker hierdie status op sy classifiedertensies gebruik?',
    ],
    "no_location" => "Geen ligging is gekies nie.",
    "continue" => 'Aanhou',
    "gallery" => 'Galery',
    "classified" => 'Classifiedertensie',
    "classifieds" => 'Classifiedertensies',
    "were_found" => 'was gevind.',

    // Pending screen
    'pending_message_1' => 'Die classifiedertensie is in die goedkeuringsproses',
    'pending_message_2' => "Classifiedertensie se opdateringsdatum",
    ...
    'pending_message_5' => 'Geen transaksies kan vanaf die inbelsentrum met betrekking tot die classifiedertensie in die goedkeuringsproses gedoen word nie.',
    'hours' => 'ure',

    // Preview page
    'preview_text' => [
        'part_1' => 'As die volgende inligting oor u classifiedertensie korrek is, klik op die knoppie "Gaan voort" en gaan na die volgende stap.',
    ...
    'classified_info' => 'Classifiedertensie-inligting',
    ...
    'classified_desc' => 'Classifiedertensiebeskrywing',
    'upload_photos' => 'Laai foto\'s op',
    'upload_files' => 'Laai lêers op',
    'additional_fields' => 'Bykomende velde',
    'classified_location' => 'Classifiedertensie-ligging',
    'owner' => 'Eienaar',
    'default_owner_instruction' => 'Die eienaar is die huidige gebruiker as geen gebruiker gekies word nie',
    'create_page_subtitle' => 'Skep die classifiedertensie foutloos deur gedetailleerde inligting oor u classifiedertensie in te voer.',
    'with_my_phone_numbers' => 'With my phone numbers',
    'not_with_my_phone_numbers' => "I don't want to be reached by phone",
    'how_can_you_be_contacted' => "How can you be contacted?",

    // Listing page
    'ad_title' => 'Classifiedertensietitel',
    'listing_date' => 'Lysdatum',
    'view' => 'Beskou',
    'classifieds_with_map' => 'Classifiedertensies Met Kaart',
    'classifiedanced_sorting' => 'Gevorderde sortering',
    'filter_by_word' => 'Filtreer volgens woord',
    'filter_by' => 'Filtreer volgens: naam',

    'free' => 'Vry',
    'ad_date' => 'Classifiedertensiedatum',
