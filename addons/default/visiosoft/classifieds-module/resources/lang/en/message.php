...
return [
    ...
    'success_delete' => 'Classified Deleted',
    'pending_classified_status' => 'Your classified is pending approval by the Editor.',
    'extended' => ':number classified(s) has been extended successfully.',
    ...
    'no_add_found' => 'No Classified Found!',
    'replicated_success' => 'The classified has been replicated successfully!',
    'classified_doesnt_exist' => "This classified doesn't exist!",
    'select_location_error' => "Please select a location on the map!",
    'this_classified_is_not_valid_anymore' => "This classified is not valid anymore!",
    'approve_status_change' => "Your Classified's Status Has Been Set to Active!",
    'passive_status_change' => "Your Classified's Status Has Been Set to Passive!",
	'sold_status_change' => "Your Classified's Status Has Been Set to Sold!",
	'status_change' => "Your Classified's Status Has Been Set to :status!",
