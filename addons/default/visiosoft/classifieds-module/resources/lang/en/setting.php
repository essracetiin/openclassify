...
return [
    ...
    'hide_zero_price' => [
        ...
        'instructions' => 'Hide the price if the classified price is 0',
    ],
    ...
    'default_country' => [
        'name' => 'Default Classified Country',
    ],
    'hide_price_categories' => [
        'name' => 'Hide Price On Categories',
        'instructions' => 'The price will be hidden when you create an classified or view an classified under these categories.'
    ],
    'free_currencyconverterapi_key' => [
        'name' => 'Currency Converter API Key'
    ],
    'default_city' => [
        'name' => 'Default Classified City',
    ],
    'default_district' => [
        'name' => 'Default Classified District',
    ],
    'default_neighborhood' => [
        'name' => 'Default Classified Neighborhood',
    ],
    'default_currency' => [
        'name' => 'Default Classified Currency',
    ],
    'default_GET' => [
        'name' => 'Default Classified GET',
    ],
    'twitter' => [
        'name' => 'Twitter',
    ],
    ...
    'hide_configurations' => [
        ...
        'instructions' => 'Hide the Configurations Button in the Classified Preview Page',
    ],
    'make_all_fields_required' => [
        'name' => 'Make All Fields Required',
        'instructions' => 'Require the user to fill the Price and Description fields when creating an classified',
    ],
    'make_map_required' => [
        'name' => 'Make Map Required',
        'instructions' => 'Require the user to place a pin on the map when creating an classified',
    ],
    ...
    'popular_classifieds_limit' => [
        'name' => 'Popular Classifieds Limit',
    ],
    ...
    'show_breadcrumb_when_creating_ad' => [
        'name' => 'Show Breadcrumb When Creating an Classified',
    ],
    'show_classifieds_count' => [
        'name' => 'Show Classifieds Count',
        'instructions' => 'Show classifieds count on the left categories list',
    ],
    'classifieds_date_hidden' => [
        'name' => 'Hide Created Date',
        'instructions' => 'Hide created date in classifieds detail page',
    ],
    'hide_listing_header' => [
    ...
    'create_ad_button_color' => [
        'name' => 'Create Classified Button Color',
        'instructions' => 'Changes the button that shows up when the new classified category selection is finished.'
    ],
    ...
    'show_finish_and_publish_date' => [
        ...
        'instructions' => 'Displays the publish_at and finish_at fields on the classified creation page.'
    ],
    'show_tax_field' => [
        'name' => 'Show Tax Field',
