...
return [
    ...
    'classified_actions' => 'Ενέργειες διαφημίσεων',
    'edit' => 'Επεξεργασία',
    'approve' => 'Εγκρίνω',
    'passive' => "Παθητικός",
	'sold' => 'Πωληθεί',
    'offered_by' => 'Προσφέρεται από',
    'more_classifieds_by' => 'Περισσότερες διαφημίσεις από',
    ...
    'recommended_classifieds' => 'Προτεινόμενες διαφημίσεις για εσάς',
    'new' => 'Νέος',
   ...
   ο πωλητής θα επικοινωνήσει μαζί σας σύντομα.',
    'classified_id' => 'Αναγνωριστικό διαφήμισης',
    'contact_with' => 'Επικοινωνήστε με',
    'create_classified' => 'Δημιουργία διαφήμισης',
    'edit_classified' => 'Επεξεργασία διαφήμισης',
    'mandatory_fields' => 'Υποχρεωτικά πεδία',
    'classified_post' => 'Δημοσίευση διαφημίσεων',
    ...
    'post_free_classified' => 'Δημοσίευση δωρεάν διαφήμισης',
    ...
    'featured_classifieds' => "Προτεινόμενες διαφημίσεις",
    'trending_classifieds' => 'Αλλαγή διαφημίσεων',
    ...
    'no_classifieds' => 'Χωρίς διαφημίσεις!',
    'show_display_mode' => [
        'map' => 'Χάρτης',
        'list' => 'Λίστα',
    ],
    ...
    'classified_info' => 'Πληροφορίες διαφήμισης',
    ...
    'view' => 'Θέα',
    'classifieds_with_map' => 'Διαφημίσεις με χάρτη',
    'classifiedanced_sorting' => 'Προηγμένη ταξινόμηση',
