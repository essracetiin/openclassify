...
return [
    ...
    'pending_classified_status' => 'Η διαφήμισή σας εκκρεμεί έγκριση από το Editor.',
    ...
    'classified_doesnt_exist' => "Αυτή η διαφήμιση δεν υπάρχει!",
    'select_location_error' => "Επιλέξτε μια τοποθεσία στον χάρτη!",
    'this_classified_is_not_valid_anymore' => "Αυτή η διαφήμιση δεν είναι πλέον έγκυρη!",
