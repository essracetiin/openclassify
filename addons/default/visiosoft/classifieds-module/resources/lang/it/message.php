...
return [
    ...
    'create_classified_with_post_cat' => [
        'title' => "Post an Classified in just 30 seconds",
        'success' => true,
    ...
    'pending_classified_status' => 'Il tuo annuncio è in attesa di approvazione da parte dell\'Editore.',
    ...
    'classified_doesnt_exist' => "Questo annuncio non esiste!",
    'select_location_error' => "Seleziona una posizione sulla mappa!",
    'this_classified_is_not_valid_anymore' => "Questo annuncio non è più valido!",
